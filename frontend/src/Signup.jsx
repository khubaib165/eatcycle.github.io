...
import { Mail, Lock, User, AlertCircle, CheckCircle, Building } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSubmit = async () => {
    ...
    // Validation
    if (!formData.name || !formData.email || !formData.password || !formData.confirmPassword || !formData.instituteName) {
      ...
      <div style={{ maxWidth: '28rem', width: '100%' }}>
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ color: '#6B7280' }}>Sign up to get started</p>
          </div>
          ...
          {success && (
            <div style={{
              ...
              <p style={{ color: '#15803D', fontSize: '0.875rem' }}>Account created successfully! Redirecting...</p>
            </div>
          )}
